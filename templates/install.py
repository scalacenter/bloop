...
BLOOP_SERVER_TARGET       = join(BLOOP_INSTALLATION_TARGET, "#BLOOP_SERVER_CMD#")
BLOOP_SHELL_TARGET        = join(BLOOP_INSTALLATION_TARGET, "#BLOOP_SHELL_CMD#")
BLOOP_CLIENT_TARGET       = join(BLOOP_INSTALLATION_TARGET, "#BLOOP_CLIENT_CMD#")
...
BLOOP_ARTIFACT = "ch.epfl.scala:bloop-frontend_2.12:" + BLOOP_VERSION
...
def coursier_bootstrap(target, main):
    call(["coursier", "bootstrap", BLOOP_ARTIFACT, "-o", target, "--standalone", "--main", main])
