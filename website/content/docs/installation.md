...
plugins to generate these files for sbt, Maven, Gradle and mill. In the future,
we'd like to support Bazel too (get in touch if you're interested in working on
it).
...
you think you can help improve the quality of the plugin, come over our
[Gitter channel](https://gitter.im/scalacenter/bloop) and eyeball Maven's
[open issues](https://github.com/scalacenter/bloop/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3Amaven).
